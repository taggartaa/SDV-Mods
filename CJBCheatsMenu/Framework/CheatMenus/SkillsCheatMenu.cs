    ...
    internal class SkillsCheatMenu : CheatMenu
    {
        ...
        public override List<Menu.IOptionGroup> OptionGroups
        {
            get
            {
                ...
                professionsOptionGroup.Options.Add(new AddProfessionCheckbox(I18n.Get("professions.fishing.luremaster"), StardewValley.Farmer.baitmaster));
                professionsOptionGroup.Options.Add(new AddProfessionCheckbox(I18n.Get("professions.fishing.mariner"), StardewValley.Farmer.mariner));
